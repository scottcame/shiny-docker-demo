...
nationalShp <- readOGR('/opt/data/Shapefiles/australia/election-districts/national/COM_ELB.TAB', layer="COM_ELB", stringsAsFactors = FALSE, verbose=FALSE)
...
ggplot(ElectionResults2016, aes(x=UnemploymentRate, y=LiberalCoalitionPct)) + geom_point() + geom_smooth(method='lm') +
  ...
  labs(title='Correlation of Unemployment Rate and Liberal Coalition Vote Share', subtitle='By Electoral District, 2016 Federal Election for House of Representatives',
